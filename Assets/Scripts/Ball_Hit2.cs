...
public class Ball_Hit2 : MonoBehaviour
{
    ...
    {
        Hit = true;
        SetTime = PlayerMove2.Time;
        DistanceX = PlayerMove2.DistanceX;
        DistanceY = PlayerMove2.DistanceY;
        Debug.Log(PlayerMove2.Time);
        Debug.Log("DistanceX = " + PlayerMove2.DistanceX);
        Debug.Log("DistanceY = " + PlayerMove2.DistanceY);
