...
public class Ball_Hit : MonoBehaviour
{
    ...
    {
        Hit = true;
        SetTime = PlayerMove.Time;
        DistanceX = PlayerMove.DistanceX;
        DistanceY = PlayerMove.DistanceY;
        Debug.Log(PlayerMove.Time);
        Debug.Log("DistanceX = " + PlayerMove.DistanceX);
        Debug.Log("DistanceY = " + PlayerMove.DistanceY);
